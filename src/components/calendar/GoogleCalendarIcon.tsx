// The real Google Calendar app icon (2020 redesign), not a lookalike — traced from Google's own
// asset: https://commons.wikimedia.org/wiki/File:Google_Calendar_icon_(2020).svg
